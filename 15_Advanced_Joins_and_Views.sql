-- W załączniku znajdują się kody do stworzenia bazy danych i tabel do tego zadania oraz wypełnienia ich danymi. Wybierz z niego te fragmenty, które będą Ci potrzebne do wykonania poleceń.
