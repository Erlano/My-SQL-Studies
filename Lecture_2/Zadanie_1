...
INSERT INTO biblioteczka (id, tytul, data_zakupu) VALUES (748372, 'Genesis. Artificial Intelligence, Hope and the Human Spirit', '2025-07-12');
INSERT INTO biblioteczka (id, tytul, data_zakupu) VALUES (244986, 'Przebudzenie Lewiatana', '2025-05-25');
INSERT INTO biblioteczka (id, tytul, data_zakupu) VALUES (597634, 'Polska Piastów', '2025-03-04');

UPDATE biblioteczka
	SET id = 987432,
    tytul = 'Przestrzeń Objawienia',
    data_zakupu = '2025-08-15'
WHERE id = 597634;

ALTER TABLE biblioteczka ADD COLUMN autor TEXT;

UPDATE biblioteczka SET autor = 'Alastair Reynolds' WHERE id = 987432;
UPDATE biblioteczka SET autor = 'Henry Alfred Kissinger' WHERE id = 748372;
UPDATE biblioteczka SET autor = 'James S. A. Corey' WHERE id = 244986;

DELETE FROM biblioteczka WHERE id = 244986;
DELETE FROM biblioteczka WHERE id = 748372;
