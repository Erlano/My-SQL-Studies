/* Bazy danych i manipulacja danymi - Zadanie 3
...
('Mama', 'Ciepły szal', 150.00, 'Zalando'),
('Tata', 'Książka historyczna', 80.00, 'Empik'),
('Ania', 'Słuchawki bezprzewodowe', 300.00, 'Media Expert'),
('Piotr', 'Gra planszowa', 120.00, 'Allegro'),
('Babcia', 'Zestaw herbat', 70.00, 'Czas na Herbatę');
